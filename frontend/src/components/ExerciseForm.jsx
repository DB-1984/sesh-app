  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)}>
      ...
      <Card className="w-full border-none bg-transparent shadow-none mb-6">
        <CardContent className="flex flex-col mx-auto w-full gap-4 px-4">
          <Input
          ...
          <div className="flex flex-col gap-2 mt-2 pt-2">
            <Button
              type="submit"
              className="w-full md:w-sm md:mx-auto font-bold py-6"
            >
              {submitLabel}
            </Button>
            ...
            {onCancel && (
              <Button
                ...
                variant="ghost"
                onClick={onCancel}
                className="text-zinc-500 hover:text-black pt-2 dark:hover:text-white py-6 font-normal"
              >
                Cancel Edit
              </Button>
            )}
