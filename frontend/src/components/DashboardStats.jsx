...
import { resetMode } from "../slices/modeSlice";
...
export default function DashboardStats() {
  ...
  return (
    <div className="flex flex-col min-h-full gap-6">
      ...
      {/* OBJECTIVE*/}
      <Card className="bg-zinc-900 text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 border-none shadow-xl">
        {" "}
      ...
      {/* QUICK ACTIONS — dark */}
      <Card className="border-none bg-zinc-100/80 dark:bg-zinc-900/50">
