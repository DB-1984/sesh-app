...
export default function ViewSesh() {
  ...
  return (
    <div className="grid min-h-[calc(100vh-64px)] max-w-6xl mx-auto lg:grid-cols-2 overflow-hidden">
      {/* LEFT PANEL */}
      <div className="h-[calc(100vh-10px)] transparent">
        <ScrollArea className="h-full">
          <div className="max-w-full py-12 px-8 md:px-12 space-y-6">
            {/* Sesh meta card */}
            <Card>
            ...
            <Card className="bg-card">
              <CardHeader className="py-2">
                <CardTitle className="text-base leading-none font-base tracking-tight text-xl">
      ...
      <div className="h-[calc(100vh-64px)] overflow-hidden">
        <div className="h-full w-full px-8 md:px-12 py-12 space-y-6 overflow-hidden">
            ...
            <CardHeader className="py-4">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <CardTitle className="mt-2 text-1xl leading-none">
                    Logged exercises
                  </CardTitle>
                </div>
                ...
                <div className="p-6 space-y-3">
                  {currentSesh.exercises?.length ? (
                    currentSesh.exercises.map((exercise) => (
                      <Card
                        key={exercise._id}
                        className="group overflow-hidden transition-all hover:shadow-md hover:-translate-y-[1px]"
                      >
                        <div className="flex items-center justify-between gap-4 p-4 overflow-hidden">
                          <div className="flex items-center gap-4 flex-1 min-w-0 w-0 overflow-hidden">
                            ...
                            <div className="flex-1 min-w-0 w-0 overflow-hidden">
                              <h3 className="block max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-base font-semibold tracking-tight capitalize">
                                {exercise.exercise}
                              </h3>

                              <div className="mt-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs md:text-sm text-muted-foreground">
                                ...
                                <span className="hidden md:block max-w-[220px] overflow-hidden text-ellipsis whitespace-nowrap">
                                  {exercise.comments}
                                </span>
                              </div>
                            </div>
